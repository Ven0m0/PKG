...
class TestOutputUtils(unittest.TestCase):
    ...
    def test_info(self):
        ...
        try:
            ...
            self.assertEqual(captured_output.getvalue(), f"{vp_dev.Colors.B}→{vp_dev.Colors.N} test message\n")
        finally:
    ...
    def test_ok(self):
        ...
        try:
            ...
            self.assertEqual(captured_output.getvalue(), f"{vp_dev.Colors.G}✓{vp_dev.Colors.N} test message\n")
        finally:
            sys.stdout = sys.__stdout__
    ...
    def test_warn(self):
        ...
        try:
            ...
            self.assertEqual(captured_output.getvalue(), f"{vp_dev.Colors.Y}⚠{vp_dev.Colors.N} test message\n")
        finally:
            sys.stdout = sys.__stdout__
    ...
    def test_err(self):
        ...
        try:
            ...
            self.assertEqual(captured_output.getvalue(), f"{vp_dev.Colors.R}✗{vp_dev.Colors.N} error message\n")
        finally:
